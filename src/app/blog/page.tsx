        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#5F687A] max-w-md mx-auto">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit non lorem morbi suscipit interdum cras vulputate amet arcu.
            </p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
              <div className="order-2 lg:order-1">
                <div className="flex items-center gap-4 mb-6">
                  <Badge className={`${featuredPost.categoryColor} text-white border-0 px-4 py-2 text-sm font-medium`}>
                ...
                <p className="text-[#5F687A] text-lg mb-6 leading-relaxed">
                  Lorem ipsum dolor sit amet consectetur adipiscing id eliglarim vel tempor elit risus sollicitudin sit lorem.
                </p>
                <Link 
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-3xl font-bold text-[#1C1F23]">Latest articles</h2>
            ...
            {regularPosts.map((post) => (
              <article key={post.id} className="group">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-6 relative">
                  ...
                  />
                  <Badge className={`${post.categoryColor} text-white border-0 absolute top-6 left-6 px-3 py-1.5 text-sm font-medium`}>
                    {post.category}
                  </Badge>
                </div>
          ...
          <div className="flex items-center justify-center gap-5">
            ...
            <Button 
              className="px-7 py-3 rounded-full bg-[#005DFF] text-white hover:bg-[#004BCC]"
            >
              Next
            </Button>
          </div>
