...
const blogPosts = [
  {
    ...
    excerpt: "Lorem ipsum dolor sit amet consectetur adipiscing elit pharetra eget sagittis sapien neque pellentesque rhoncus iaculis purus erat neque ultrices amet odio diam tristique eu id.",
    category: "Tips",
    categoryColor: "bg-[#005DFF]",
    date: "Jan 24, 2024",
    heroImage: "https://api.builder.io/api/v1/image/assets/TEMP/17e6b9ce14195373e99cb1b9f87fec54ce8647af?width=2392",
    content: `
  ...
  },
  {
    ...
    date: "Jan 30, 2024",
    heroImage: "https://api.builder.io/api/v1/image/assets/TEMP/226845328f8dbd5882fd4d1be833f9a516770f0f?width=776",
  ...
  },
  {
    ...
    date: "Jan 27, 2024",
    heroImage: "https://api.builder.io/api/v1/image/assets/TEMP/4f52c8653982d42009da5aafa5db05db111d32ee?width=776",
    content: `Sample content for this article...`
  }
];
...
const relatedPosts = [
  {
    ...
    categoryColor: "bg-[#6C38FF]",
    date: "Jan 21, 2024",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/65ba2bd750e8ba043cee9de1e51e0571dfd571d3?width=776",
    excerpt: "Aliquam senectus turpis quam odio proin nis nec massa nisl ac etiam sed feugiat nullam neque."
  },
  {
    id: 4,
    ...
    categoryColor: "bg-[#005DFF]",
    date: "Jan 18, 2024",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/47b7f003a9c226f500d78c6a84737b9b47e8855c?width=776",
  ...
  },
  {
    ...
    categoryColor: "bg-[#4BA9FF]",
    date: "Jan 15, 2024",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/e2567beafe6f11747291c2b6b6a6a87d46327c66?width=776",
    excerpt: "Porta mauris at sem placerat vulputate porttitor arcu suspendisse dui mi duis non tristique."
  }
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-4 mb-6">
              <Badge className={`${post.categoryColor} text-white border-0 px-6 py-3.5 text-base font-medium rounded-full`}>
                {post.category}
              </Badge>
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="mb-12">
                ...
                <div className="space-y-6 text-[#5F687A] text-base leading-relaxed">
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit quis ultricies sed non sodales morbi ornare non ullamcorper nulla aliquet viverra non est nulla bibendum <a href="#" className="text-[#005DFF] underline">nunc ac egestas</a> habitant.
                  </p>
              ...
              <div className="mb-12">
                ...
                <p className="text-[#5F687A] text-base leading-relaxed mb-6">
                  Lorem ipsum dolor sit amet consectetur adipiscing elit orci fringilla massa tellus id nunc non facilisi velit ultrices aliquam fusce mauris consequat ultricies sed ut cras tortor amet risus viverra augue proin eget sem elit pharetra blandit dolor senectus amet <span className="font-bold text-[#1C1F23]">ante nulla convallis.</span>
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-[#5F687A] text-base leading-relaxed">
                  Eget lorem dolor sed viverra ipsum nunc aliquet bibendum felis donec et odio pellentesque diam volutpat commodo sed egestas aliquam sem fringilla ut morbi tincidunt <a href="#" className="text-[#005DFF] underline">augue interdum</a> velit euismod eu tincidunt tortor aliquam nulla facilisi aenean sed adipiscing diam donec.
                </p>
              </div>
            </div>
      ...
      <section className="bg-[#F9FAFC] py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-32">
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-3xl font-bold text-[#1C1F23]">Related articles</h2>
            <Button variant="outline" className="border-[#101B44] text-[#101B44] px-5 py-3 rounded-full font-normal hover:bg-[#101B44] hover:text-white">
              Browse all articles
            </Button>
          </div>
              ...
              <article key={relatedPost.id} className="group">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-6 relative">
                  <img 
                    ...
                    className="w-full h-full object-cover"
                  />
                  <Badge className={`${relatedPost.categoryColor} text-white border-0 absolute top-6 left-6 px-3 py-2 text-sm font-medium rounded-full`}>
                    {relatedPost.category}
                  </Badge>
                </div>
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-[#1C1F23] leading-tight">
                    <Link href={`/blog/${relatedPost.id}`} className="hover:text-[#005DFF] transition-colors">
                      {relatedPost.title}
                    </Link>
                  </h3>
                  <p className="text-[#5F687A] text-base leading-relaxed">
