              ...
              <div key={index} className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                    <span className="text-blue-600 font-semibold">{notary.name[0]}</span>
                  </div>
                  <div className="ml-4">
                ...
                <div className="flex items-center mb-3">
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm font-medium">{notary.rating}</span>
                  </div>
                  <span className="text-gray-500 text-sm ml-2">({notary.reviews} reviews)</span>
                </div>
            ...
            {[
              {
                step: "1",
                title: "Find a Notary",
                description: "Search for certified notaries in your area or book an online session"
              },
              {
                step: "2", 
                title: "Schedule Appointment",
                description: "Choose a convenient time and location for your notarization"
              },
              {
                step: "3",
                title: "Get Notarized",
                description: "Meet with your notary and get your documents officially notarized"
              }
            ].map((item, index) => (
