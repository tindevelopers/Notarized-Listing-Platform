        ...
        <div className="p-10 space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-3xl font-semibold text-black">
              Hello, {user.user_metadata?.full_name || user.email?.split("@")[0] || "Shannon"} 👋
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="border-[#E5E7EB]">
              <CardContent className="p-5">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm text-black font-medium">Total complete transactions</h3>
                    <div className="text-4xl font-bold text-black mt-2">{stats.totalTransactions.toLocaleString()}</div>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-[#575757]">
                    <span>Total invoice value:</span>
                    <span className="font-semibold">${stats.totalInvoiceValue.toLocaleString()}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-[#E5E7EB]">
              <CardContent className="p-5">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm text-black font-medium">Total number of active notaries</h3>
                    <div className="text-4xl font-bold text-black mt-2">{stats.activeNotaries}</div>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-[#575757]">
                    <span>Total notary applications:</span>
                    <span className="font-semibold">{stats.totalNotaryApplications}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-[#E5E7EB]">
              <CardContent className="p-5">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm text-black font-medium">Total number of clients</h3>
                    <div className="text-4xl font-bold text-black mt-2">{stats.totalClients.toLocaleString()}</div>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-[#575757]">
                    <span>Average client value:</span>
                    <span className="font-semibold">${stats.averageClientValue.toFixed(2)}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="border-[#E5E7EB]">
              <CardContent className="p-5">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm text-black font-medium">Invoice total this month</h3>
                    <div className="flex items-center gap-3 mt-2">
                      <div className="text-3xl font-bold text-black">
                        ${stats.monthlyInvoiceTotal.toLocaleString()}
                      </div>
                      <div className="text-sm text-black">({stats.monthlyInvoiceCount.toLocaleString()})</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1 text-xs text-black">
                      <span>Last month:</span>
                      <span className="font-semibold">${stats.lastMonthInvoice.toLocaleString()}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <ArrowUp className="h-4 w-4 text-[#1A963F]" />
                      <span className="text-xs font-semibold text-[#1A963F]">{stats.invoiceGrowth}%</span>
                    </div>
                  </div>
                  <div className="h-24 bg-[#F7F9FC] rounded-md flex items-end justify-end p-4">
                    {/* Simplified chart representation */}
                    <svg width="150" height="60" viewBox="0 0 150 60" className="text-[#1A963F]">
                      <path
            ...
            <Card className="border-[#E5E7EB]">
              <CardContent className="p-5">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm text-black font-medium">Payments made this month</h3>
                    <div className="flex items-center gap-3 mt-2">
                      <div className="text-3xl font-bold text-black">
                        ${stats.monthlyPayments.toLocaleString()}
                      </div>
                      <div className="text-sm text-black">({stats.monthlyPaymentCount})</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1 text-xs text-black">
                      <span>Last month:</span>
                      <span className="font-semibold">${stats.lastMonthPayment.toLocaleString()}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <ArrowUp className="h-4 w-4 text-[#1A963F]" />
                      <span className="text-xs font-semibold text-[#1A963F]">{stats.paymentGrowth}%</span>
                    </div>
                  </div>
                  <div className="h-24 bg-[#F7F9FC] rounded-md flex items-end justify-end p-4">
                    {/* Simplified chart representation */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="border-[#E5E7EB]">
              <CardContent className="p-5">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm text-black font-medium">Notaries awaiting approval</h3>
                    <div className="text-4xl font-bold text-black mt-2">{stats.pendingNotaries}</div>
                  </div>
                  <Link
            ...
            <Card className="border-[#E5E7EB]">
              <CardContent className="p-5">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm text-black font-medium">Transactions awaiting payment</h3>
                    <div className="text-4xl font-bold text-black mt-2">{stats.pendingTransactions}</div>
                  </div>
                  <Link
            ...
            <Card className="border-[#E5E7EB]">
              <CardContent className="p-5">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm text-black font-medium">Invoices awaiting payment</h3>
                    <div className="text-4xl font-bold text-black mt-2">{stats.pendingInvoices}</div>
                  </div>
                  <Link
